...
class BankGuiCtk(customtkinter.CTk):
    ...
    def __init__(self, dataBase=BankDbSqlite('AppDb.db')):
        ...
        self.account_label.place(x=1000, y=40)
        self.account_entry = self.newCtkEntry()
        self.account_entry.place(x=1000, y=80)

        # 'Name' Label and Entry Widgets
        self.name_label = self.newCtkLabel('Name')
        self.name_label.place(x=1000, y=120)
        ...
        self.status_cbox.place(x=1000, y=360)
        ...
        self.add_button = self.newCtkButton(text='Add Account',
                                ...
                                hoverColor='#00FFFF',
                                borderColor='#F0FFFF')
        self.add_button.place(x=1000,y=675)
        ...
        self.new_button = self.newCtkButton(text='New Account',
                                ...
                                hoverColor='#00FFFF',
                                borderColor='#7DF9FF')
        self.new_button.place(x=1000,y=425)
        ...
        self.update_button = self.newCtkButton(text='Update Account',
                                    ...
                                    hoverColor='#00FFFF',
                                    borderColor='#7DF9FF')
        self.update_button.place(x=1000,y=475)
        ...
        self.delete_button = self.newCtkButton(text='Delete Account',
                                    ...
                                    hoverColor='#AE0000',
                                    borderColor='#E40404')
        self.delete_button.place(x=1000,y=725)
        ...
        self.export_button = self.newCtkButton(text='Export to CSV',
                                    ...
                                    hoverColor='#00FFFF',
                                    borderColor='#7DF9FF')
        self.export_button.place(x=1000,y=575)
        ...
        self.import_button = self.newCtkButton(text='Import from CSV',
                                    ...
                                    hoverColor='#00FFFF',
                                    borderColor='#7DF9FF')
        self.import_button.place(x=1000,y=525)
        ...
        self.exportJSON_button = self.newCtkButton(text='Export to Json',
                                    ...
                                    hoverColor='#00FFFF',
                                    borderColor='#7DF9FF')
        self.exportJSON_button.place(x=1000,y=625)
